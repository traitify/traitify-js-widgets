...
MockRequest.addMock({
  method: "GET",
  url: "https://api-sandbox.traitify.com/v1/assessments/played/matches/careers?number_of_matches=8",
  params: "",
  response: apiFactory.build("careers", {number: 8})
})
MockRequest.addMock({
  method: "GET",
  url: "https://api-sandbox.traitify.com/v1/assessments/unplayed/matches/careers?number_of_matches=8",
  params: "",
  response: apiFactory.build("careers", {number: 8})
})
MockRequest.addMock({
  method: "GET",
  url: "https://api-sandbox.traitify.com/v1/assessments/played_with_blend/matches/careers?number_of_matches=8",
  params: "",
  response: apiFactory.build("careers", {number: 8})
})
