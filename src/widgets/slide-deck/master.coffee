        ...
        if sentSlides == widget.data.get("slidesToPlayLength")
          ...
          if widget.options && widget.options.showResults != false
            ...
            if widgets.personalityTraits
              ...
              widgets.personalityTraits = Traitify.ui.load("perscallbacks = widgets.personalityTraits.callbacksonalityTraits", widget.assessmentId, widgets.personalityTraits.target, widgets.personalityTraits.options)
